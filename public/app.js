...
function setupImagePasteAndDrop() {
  // Ctrl+V / botão direito > Colar imagem diretamente no chat.
  ...
  // Arrastar uma imagem para a área de mensagens ou para o compositor.
  ...
  dropTargets.forEach(target => {
    ...
    target.addEventListener("dragleave", e => {
      ...
      if (!dragDepth) target.classList.remove("drop-image-active");
    });
    target.addEventListener("drop", e => {
      ...
      if (!files.length) return toast("Arraste uma imagem para enviar.", true);
